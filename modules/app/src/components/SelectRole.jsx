  ...
  return (
    ...
    >
      <button
        ...
        type="button"
        className="relative w-full h-14 bg-slate-800 text-slate-300 border border-slate-800 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-pointer focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-slate-500 sm:text-sm"
